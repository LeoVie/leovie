...
- [phpstan/phpstan-doctrine](https://github.com/phpstan/phpstan-doctrine) ([1.3.61](https://github.com/phpstan/phpstan-doctrine/releases/tag/1.3.61), 3 days ago) - Doctrine extensions for PHPStan
...
- [renyuneyun/parse-link-header-ts](https://github.com/renyuneyun/parse-link-header-ts) - Parses a link header and returns paging information for each contained link. (1 week ago)
