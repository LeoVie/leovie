...
- [LeoVie/clover-crap-check](https://github.com/LeoVie/clover-crap-check) ([v1.0.1](https://github.com/LeoVie/clover-crap-check/releases/tag/v1.0.1), today) - 
...
- [Allow crap check results to have different order and still be conside…](https://github.com/LeoVie/clover-crap-check/pull/8) on [LeoVie/clover-crap-check](https://github.com/LeoVie/clover-crap-check) (today)
